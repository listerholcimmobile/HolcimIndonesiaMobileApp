package com.altimetrik.holcim.controller.webservice;
...
public class WebServiceRESTBasic {
	...
	/**
	 * 
	 * @param pWebServiceURL
	 *            - URL to web service call, NO include method
	 * @param context
	 *            - Current Context
	 */
	 ...
	 * 
	 * @param methodName
	 *            - Name of the web service method to complete the URL call
	 * @param pParams
	 *            - Parameter to call web service, as a List<NameValuePair> with
	 *            <Parameter Name, Parameter Value>
	 * @param pHeaders
	 *            - Headers to add to the call, as a List<NameValuePair> with
	 *            <Header Name, Header Value>
	 * @param pContentType
	 *            - Content type to set in the call header
	 * @return String
	 * @throws WebServiceException
	 */
	public String callGETString(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders,
			String pContentType) throws WebServiceException {
		HttpResponse getResponse = null;
		try {
			getResponse = this.webGet(pMethodName, pParams, pHeaders,
					pContentType);
		...
		if (getResponse == null) {
			throw new WebServiceException(
					WebServiceException.EMPTY_RESPONSE_EXCEPTION_STATUS,
		...
		try {
			...
			throw new WebServiceException(
					WebServiceException.DECODING_RESPONSE_ENTITY_EXCEPTION_STATUS,
	...
	/**
	 * Call a GET web service that return a InputStream from the content of the
	 * response
	 * 
	 * @param methodName
	 *            - Name of the web service method to complete the URL call
	 ...
	 * @throws WebServiceException
	 */
	public InputStream callGETInputStream(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders,
			String pContentType) throws WebServiceException {
		HttpResponse getResponse = null;
		try {
		...
		if (getResponse.getStatusLine().getStatusCode() != 200) {
			throw new WebServiceException(
					WebServiceException.BAD_RESPONSE_CODE_EXCEPTION_STATUS,
					WebServiceException.BAD_RESPONSE_CODE_EXCEPTION_MESSAGE,
					String.valueOf(getResponse.getStatusLine().getStatusCode()),
		...
		try {
			...
			throw new WebServiceException(
					WebServiceException.DECODING_RESPONSE_ENTITY_CONTENT_ACCESS_EXCEPTION_STATUS,
			...
			throw new WebServiceException(
					WebServiceException.DECODING_RESPONSE_ENTITY_CONTENT_EXCEPTION_STATUS,
	...
	/**
	 * Call a DELETE web service assuming that the response error/message came
	 * in the response body, normally this methods returns string specific data
	 * to parse (text, XML, JSON, etc.)
	 * 
	 * @param methodName
	 *            - Name of the web service method to complete the URL call
	 * @param pParams
	 ...
	 * @throws WebServiceException
	 */
	public String callDELETEString(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders)
			throws WebServiceException {
	...
	/**
	 * Call a POST web service with JSON parameters that return a String from
	 ...
	 *            - Content type to set in the call header
	 * @param pUserAgent
	 *            - User agent to set in the call header
	 * @param pData
	 *            - Data to add to the POST body as parameters to the call (XML,
	 *            JSON, etc)
	 * @return String
	 * @throws WebServiceException
	 */
	public String callPOSTJSONString(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders,
			String pUserAgent) throws WebServiceException {
		...
		for (NameValuePair param : pParams) {
			try {
				...
				throw new WebServiceException(
						WebServiceException.ENCODING_EXCEPTION_STATUS,
		...
		try {
			postResponse = this.webPost(pMethodName, pHeaders,
					HttpUtils.CONTENT_TYPE_JSON_UTF8, pUserAgent,
					jsonObject.toString());
		} catch (WebServiceException e) {
			throw e;
		}
	...
	public String callPOSTJSONString(String pMethodName, JSONObject pParams,
			List<NameValuePair> pHeaders, String pUserAgent)
			throws WebServiceException {
		HttpResponse postResponse = null;
	 ...
	 * @throws WebServiceException
	 */
	public String callPOSTJSONString(String pMethodName, String pParams,
			List<NameValuePair> pHeaders, String pUserAgent)
			throws WebServiceException {
		HttpResponse postResponse = null;
		...
		try {
			postResponse = this.webPost(pMethodName, pHeaders,
					HttpUtils.CONTENT_TYPE_JSON_UTF8, pUserAgent, pParams);
		} catch (WebServiceException e) {
			throw e;
		}
		if (postResponse == null) {
	...
	public String callPOSTInputStreamString(String pMethodName,
			InputStreamEntity pParams, List<NameValuePair> pHeaders,
			String pUserAgent) throws WebServiceException {
		HttpResponse postResponse = null;

		try {
			postResponse = this.webPost(pMethodName, pHeaders, pUserAgent,
					pParams);
		} catch (WebServiceException e) {
			throw e;
		}
	 ...
	 * @throws WebServiceException
	 */
	private HttpResponse webGet(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders,
			String pContentType) throws WebServiceException {
		...
		try {
			...
			throw new WebServiceException(
					WebServiceException.HTTP_CLIENT_EXECUTION_EXCEPTION_STATUS,
		...
		if (response.getStatusLine().getStatusCode() != 200) {
			throw new WebServiceException(response.getStatusLine()
	 ...
	 * @throws WebServiceException
	 */
	public HttpResponse webDelete(String pMethodName,
			List<NameValuePair> pParams, List<NameValuePair> pHeaders)
			throws WebServiceException {
	 ...
	 * @throws WebServiceException
	 */
	private HttpResponse webPost(String pMethodName,
			List<NameValuePair> pHeaders, String pContentType,
			String pUserAgent, String pData) throws WebServiceException {
	...
	private HttpResponse webPost(String pMethodName,
			List<NameValuePair> pHeaders, String pUserAgent,
			InputStreamEntity pData) throws WebServiceException {
	 ...
	 * @throws WebServiceException
	 */
	public InputStream getHttpStream(String pUrlString)
			throws WebServiceException {
		InputStream in = null;
		int response = -1;
		...
		try {
			...
			if (!(conn instanceof HttpURLConnection))
				throw new WebServiceException(
						WebServiceException.NO_HTTP_CONNECTION_EXCEPTION_STATUS,
			...
			throw new WebServiceException(
					WebServiceException.HTTP_CONNECTION_EXCEPTION_STATUS,
	...
	public void abort() throws WebServiceException {
		try {
			...
			throw new WebServiceException(
					WebServiceException.ABORT_HTTP_CONNECTION_EXCEPTION_STATUS,
