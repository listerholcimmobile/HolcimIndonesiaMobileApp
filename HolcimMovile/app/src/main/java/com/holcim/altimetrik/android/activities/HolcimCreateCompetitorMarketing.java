...
public class HolcimCreateCompetitorMarketing extends HolcimCustomActivity {
	...
	private Competitor createOrUpdateCompetitorMarketing(
		...
		if (!adapter.getCompetitorMarketing().get(5).equals("")) {
			competitorMarketing.setLastMonthCompetitorBuyingVolume(Integer
					.parseInt(adapter.getCompetitorMarketing().get(5)));
		}
							...
							public void onItemSelected(AdapterView<?> parent,
								...
								if (viewHolder.spinnerCompetitor.getAdapter() != null
									...
									if (fieldsValues.get(1).equalsIgnoreCase(
											...
											&& saleExecution != null
											&& saleExecution
													.getHilBuyingVolume() != null) {
										viewHolder.textView.setText(String
												.valueOf(saleExecution
														.getHilBuyingVolume()));
									} else if (competitorMarketing != null
											&& competitorMarketing
													.getLastMonthCompetitorBuyingVolume() != null
											&& fieldsValues.get(1).equals("")) {
										viewHolder.editTextNumber.setText(String.valueOf(competitorMarketing
												.getLastMonthCompetitorBuyingVolume()));
										fieldsValues.set(
												5,
												String.valueOf(competitorMarketing
														.getLastMonthCompetitorBuyingVolume()));
									}
								}
							}
