		...
		if(!canEdit){
			...
			saveButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					}else if(editTextLastName.getText() != null && !String.valueOf(editTextLastName.getText()).equals("")){
							...
							if (AltimetrikFileHandler.isFileExist(contact.getTempPictureFilePath(HolcimShowContactInfo.this))) {
								if (contact.isPictureFileExist(HolcimShowContactInfo.this)) {
									...
									try {
										...
										AltimetrikFileHandler.DeleteFile(contact.getPicturePath(HolcimShowContactInfo.this));
