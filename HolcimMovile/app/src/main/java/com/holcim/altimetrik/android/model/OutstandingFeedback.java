...
public class OutstandingFeedback {
    ...
    public OutstandingFeedback(Long id, String salesforceId, String description, String status, Boolean complaint, String category, String salesforceAccountId, String salesforceProspectId, long accountId, long prospectId) {
        this.id = id;
