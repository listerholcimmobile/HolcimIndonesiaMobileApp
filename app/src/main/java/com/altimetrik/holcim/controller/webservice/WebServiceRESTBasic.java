...
public class WebServiceRESTBasic {
     ...
     *
     * @param methodName   - Name of the web service method to complete the URL call
     * @param pParams      - Parameter to call web service, as a List<NameValuePair> with
     *                     <Parameter Name, Parameter Value>
     * @param pHeaders     - Headers to add to the call, as a List<NameValuePair> with
     ...
     * @param pData        - Data to add to the POST body as parameters to the call (XML,
     *                     JSON, etc)
     * @return String
     * @throws WebServiceException
     */
    public String callPOSTJSONString(String pMethodName,
        ...
        if (postResponse == null) {
            throw new WebServiceException(
                    ...
                    "",
                    WebServiceException.EMPTY_RESPONSE_EXCEPTION_EXCEPTION_USER_MESSAGE);
        } else if (postResponse.getStatusLine().getStatusCode() != 200) {
