...
public class HolcimDataSource {
    private static String mTAG = "HolcimDataSource";
    ...
    public static Prospect JSONToProspect(String pJson) throws HolcimException {
        try {
            ...
            if (jObject.has("KecamatanR__r")) {
                JSONObject jsonChildObject = (JSONObject) jObject.get("KecamatanR__r");
                prospect.setKecamatan(jsonChildObject.getString("Name"));
            }

            if (jObject.has("Prospect_Reference_Number__c")) {
                prospect.setRefnumber(jObject.getString("Prospect_Reference_Number__c"));
            }
    ...
    public static Account JSONToAccount(String pJson) throws HolcimException {
        try {
            ...
            if (jObject.has("Jelajah_Holcim_ID__c")) {
                account.setJhid(jObject.getString("Jelajah_Holcim_ID__c"));
            }
            if (jObject.has("KecamatanR__r")) {
                JSONObject jsonChildObject = (JSONObject) jObject.get("KecamatanR__r");
                account.setKecamatan(jsonChildObject.getString("Name"));
            }
            if (jObject.has("Last_Month_Buying_Volume__c")) {
                account.setLmbuyingvol(jObject.getDouble("Last_Month_Buying_Volume__c"));
            }
            return account;
        } catch (Exception e) {
            throw new HolcimException(HolcimException.PARSE_EXCEPTION,
        ...
        try {
            ...
            if (jObject.has("Last_Month_s_Competitor_Buying_Volume__c")) {
                compMarketing.setLastMonthCompetitorBuyingVolume(jObject
                        .getDouble("Last_Month_s_Competitor_Buying_Volume__c"));
            }
    ...
    public static ActionsLog JSONToActionsLog(String pJson)
        ...
        try {
            ...
            if (jObject.has("Picture1Md5__c")) {
                actionLog.setPicture1(jObject.getString("Picture1Md5__c"));
            }
            if (jObject.has("Picture2Md5__c")) {
                actionLog.setPicture2(jObject.getString("Picture2Md5__c"));
            }
            if (jObject.has("Picture3Md5__c")) {
                actionLog.setPicture3(jObject.getString("Picture3Md5__c"));
            }
            if (jObject.has("Picture4Md5__c")) {
                actionLog.setPicture4(jObject.getString("Picture4Md5__c"));
            }
            if (jObject.has("Picture_Description__c")) {
                actionLog.setPictureDescription(jObject
                        .getString("Picture_Description__c"));
            }
            if (jObject.has("Picture_Description_1__c")) {
                actionLog.setPictureDescription1(jObject
                        .getString("Picture_Description_1__c"));
            }
            if (jObject.has("Picture_Description_2__c")) {
                actionLog.setPictureDescription2(jObject
                        .getString("Picture_Description_2__c"));
            }
            if (jObject.has("Picture_Description_3__c")) {
                actionLog.setPictureDescription3(jObject
                        .getString("Picture_Description_3__c"));
            }
            if (jObject.has("Picture_Description_4__c")) {
                actionLog.setPictureDescription4(jObject
                        .getString("Picture_Description_4__c"));
            }
    ...
    public static SaleExecution JSONToSaleExecution(String pJson)
        ...
        try {
            ...
            if (jObject.has("Account_Latitude__c")) {
                saleExecution.setAcclatitude(jObject.getString("Account_Latitude__c"));
            }
            if (jObject.has("Account_Longitude__c")) {
                saleExecution.setAcclongitude(jObject.getString("Account_Longitude__c"));
            }
            ...
            if (jObject.has("Related_Contact__c")) {
                saleExecution
                        .setContactSFId(jObject.getString("Related_Contact__c"));
            }
    ...
    public static ArrayList<Contact> isContactToCreate() {
        return (ArrayList<Contact>) HolcimApp.daoSession
                ...
                .whereOr(Properties.SalesforceId.isNull(),
                        Properties.SalesforceId.eq(""),
                        ContactDao.Properties.IsEdited
                                .eq(true)).list();
    }
    ...
    public static ArrayList<OutstandingFeedback> isOutstandingFeedbackToUpload() {
        return (ArrayList<OutstandingFeedback>) HolcimApp.daoSession
                .getOutstandingFeedbackDao()
                .queryBuilder()
                .where(
                        com.holcim.altimetrik.android.model.OutstandingFeedbackDao.Properties.IsEdited.eq(true)
                )
                .list();
    }
...
//                            if (AltimetrikFileHandler.isFileExist(null)) {
    ...
    public static String getTempMediaDirActionLog(Context context,
                                                  Long actionLogId, int photoNumber) throws HolcimException {
        try {
            File path = new File(context.getFilesDir(),
                    HolcimConsts.TEMPORAL_DIRECTORY_NAME);
            File imageFile = new File(path + File.separator
    ...
    public static String GetActionLogImagePath(Context context,
        ...
        if (field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_1_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_2_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_3_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_4_FIELD_NAME)) {
            filename = actionLog.getPictureFileName(photoNumber);
        }
    ...
    public static void SaveActionLogImage(Context context,
                                          ActionsLog actionLog, String field, Bitmap bitmap, int photoNumber)
            throws HolcimException {
        try {
            AltimetrikFileHandler fileHandler = new AltimetrikFileHandler(
                    context);
            if (field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_1_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_2_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_3_FIELD_NAME) || field.equals(HolcimConsts.ACTIONLOG_SF_IMAGE_4_FIELD_NAME)) {
                fileHandler.WriteBitmapToFile(
                        actionLog.getPicturePath(context, field, photoNumber), bitmap);
            }
        } catch (HolcimException e) {
            throw e;
        } catch (AltimetrikException e) {
