...
public class SaleExecutionDao extends AbstractDao<SaleExecution, Long> {
	...
	public static class Properties {
        ...
        public final static Property Acclatitude = new Property(186, String.class,
                "acclatitude", false, "ACCLATITUDE");
        public final static Property Acclongitude = new Property(187, String.class,
                "acclongitude", false, "ACCLONGITUDE");

        public final static Property contactSFId = new Property(188,
                String.class, "contactsfId", false,
                "CONTACTSFID");
	};
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'SALE_EXECUTION' (" + //
                ...
                "'ACCLATITUDE' TEXT," + // 186: acclatitude
                "'ACCLONGITUDE' TEXT," +// 186: acclongitude
                "'CONTACTSFID' TEXT);"); //187 contacct sf id
    }
	...
	protected void bindValues(SQLiteStatement stmt, SaleExecution entity) {
        ...
        String acclatitude = entity.getAcclatitude();
        if (acclatitude != null) {
            stmt.bindString(187, acclatitude);
        }

        String acclongitude = entity.getAcclongitude();
        if (acclongitude != null) {
            stmt.bindString(188, acclongitude);
        }

        String contactSFId = entity.getContactSFId();
        if (contactSFId != null) {
            stmt.bindString(189, contactSFId);
        }
	...
	public SaleExecution readEntity(Cursor cursor, int offset) {
		SaleExecution entity = new SaleExecution(
                ...
                cursor.isNull(offset + 186) ? null : cursor
                        .getString(offset + 186),  // prospectId
                cursor.isNull(offset + 187) ? null : cursor
                        .getString(offset + 187),  //
                cursor.isNull(offset + 188) ? null : cursor
                        .getString(offset + 188)  //
		);
		return entity;
	}
	...
	public void readEntity(Cursor cursor, SaleExecution entity, int offset) {
        ...
        entity.setAcclatitude(cursor.isNull(offset + 186) ? null : cursor
                .getString(offset + 186));
        entity.setAcclongitude(cursor.isNull(offset + 187) ? null : cursor
                .getString(offset + 187));
        entity.setContactSFId(cursor.isNull(offset + 188) ? null : cursor
                .getString(offset + 188));
	}
