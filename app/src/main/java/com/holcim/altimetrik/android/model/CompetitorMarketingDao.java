    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'COMPETITOR_MARKETING' (" + //
                ...
                "'LAST_MONTH_COMPETITOR_BUYING_VOLUME' REAL," + // 17: lastMonthCompetitorBuyingVolume
    ...
    protected void bindValues(SQLiteStatement stmt, CompetitorMarketing entity) {
        ...
        Double lastMonthCompetitorBuyingVolume = entity.getLastMonthCompetitorBuyingVolume();
        if (lastMonthCompetitorBuyingVolume != null) {
            stmt.bindDouble(18, lastMonthCompetitorBuyingVolume);
        }
    ...
    public CompetitorMarketing readEntity(Cursor cursor, int offset) {
        CompetitorMarketing entity = new CompetitorMarketing( //
            ...
            cursor.isNull(offset + 17) ? null : cursor.getDouble(offset + 17), // lastMonthCompetitorBuyingVolume
    ...
    public void readEntity(Cursor cursor, CompetitorMarketing entity, int offset) {
        ...
        entity.setLastMonthCompetitorBuyingVolume(cursor.isNull(offset + 17) ? null : cursor.getDouble(offset + 17));
