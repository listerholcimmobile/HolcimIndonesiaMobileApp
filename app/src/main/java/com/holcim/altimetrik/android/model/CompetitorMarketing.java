...
public class CompetitorMarketing implements Serializable {
    ...
    private Double lastMonthCompetitorBuyingVolume;
    ...
    public CompetitorMarketing(Long id, String salesforceId, String program, String programStartDate, String programEndDate, String promotion, String promotionStartDate, String promotionEndDate, String experienceLeadCompetitors, String reasonBuyingLeadCompetitors, Double competitorMarginHIL, Double buyingPrice, Double sellingPrice, String competitorName, Integer inventory, String issue, Boolean isEdited, Double lastMonthCompetitorBuyingVolume, String otherReason, String reasonForUnsatisfiedExperience, long saleExecutionId, long competitorId) {
        this.id = id;
    ...
    public Double getLastMonthCompetitorBuyingVolume() {
        return lastMonthCompetitorBuyingVolume;
    }

    public void setLastMonthCompetitorBuyingVolume(Double lastMonthCompetitorBuyingVolume) {
        this.lastMonthCompetitorBuyingVolume = lastMonthCompetitorBuyingVolume;
    }
