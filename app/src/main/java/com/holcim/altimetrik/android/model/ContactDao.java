...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsEdited = new Property(21, Boolean.class, "isEdited", false, "IS_EDITED");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CONTACT' (" + //
                ...
                "'RETAILER_ID' TEXT," +
                "'IS_EDITED' INTEGER);"); // 20: retailerID
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Contact entity) {
        ...
        if (isEdited != null) {
            stmt.bindLong(22, isEdited ? 1l: 0l);
        }
    }
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
            ...
            cursor.isNull(offset + 21) ? null : cursor.getShort(offset + 21) != 0 // isEdited
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setIsEdited(cursor.isNull(offset + 21) ? null : cursor.getShort(offset + 21) != 0);
     }
