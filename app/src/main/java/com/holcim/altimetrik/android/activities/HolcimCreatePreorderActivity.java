...
public class HolcimCreatePreorderActivity extends HolcimCustomActivity {
    ...
    private HolcimCreatePreorderActivity activity;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        jh_id = (TextView) findViewById(R.id.jhid);
        ret_name = (TextView) findViewById(R.id.retailernameval);
        kecam = (TextView) findViewById(R.id.kec);
		...
		if (getIntent().getExtras() != null) {
			...
			if (tele_sale) {
				...
				if (isAccount) {
                    ...
                    Account account = HolcimApp.daoSession.getAccountDao().load(accountId);
                    ret_name.setText(account.getName());
                    jh_id.setText(account.getJhid());
                    kecam.setText(account.getKecamatan());
                } else {
			...
			public void onClick(View v) {
				...
				if (!tele_sale
						&& (String.valueOf(poVolume.getText()).equals("")
								|| unit.getSelectedItem().toString().equals("") )) {
					dialog.showError(
