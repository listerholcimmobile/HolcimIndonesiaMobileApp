				...
				if (contact.getAccountId() == null
					...
					try {
						if (AltimetrikFileHandler.isFileExist(contact
								...
								try {
									...
									AltimetrikFileHandler.renameFile(
											...
											HolcimDataSource
													...
													+ contact
															.getPictureFileName());
                                    contact.setPicturemd5(HolcimDataSource.getContactDir(HolcimCreateNewContactActivity.this) + File.separator + contact.getTempPictureFileName(HolcimCreateNewContactActivity.this));
								} catch (Exception e) {
								}
							} else {
								try {
                            ...
                            contact.setPicturemd5(contact.getPicturePath(HolcimCreateNewContactActivity.this));
                        }
